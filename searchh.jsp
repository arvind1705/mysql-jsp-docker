							  ...
							  if(request.getParameter("Submit")!= null)
{
 ...
 rs=stmt.executeQuery("select fname as FirstName,mname as MiddleName,lname as LastName,addr as Address,dob as DateofBirth,Age,BloodGroup,orgando as OrganToDonate,DonarStatus,Photo,llat as Latitude,llong as Longitude from organdonar where state="+"'"+t1+"'"+" and city="+"'"+t2+"'"+" and orgando="+"'"+t3+"'");
        ...
        while (rs.next())
        {
            out.println("<tr>");
                ...
                for(int x=1;x<=n;x++)
                {
                  ...
                  {
					  s5=s;
				  	out.println("<td><b><img src="images/+s5+" width=50 height=50></img></b></td>");
				  ...
				  {
				  		lng=s;
						out.println("<td><a href=locateservicecenter2.jsp?lat="+lat+"&lng="+lng+">Locate on Map</a></td>");
				  }
