				...
				<td>
						<table width="920" height="145"  border="0" cellpadding="0" cellspacing="0">
						  <tr align="left" valign="top">
							<td><p><span class="style2">Director (NOTTO)
							  4th Floor, National Institute of Pathology,
							 </span></p>
							  <p class="style2"> NIOP Building,						      </p>
							  <p class="style2">Safdarjung Hospital Campus
						      New Delhi-110029.</p>
							  <p class="style2"> NOTTO Helpline - 1800-11-4770</p>
							  <p class="style2"> Website: https://notto.gov.in
						    Email: dir@notto.nic.in</p></td>
						  </tr>
						</table>
				</td>
			  </tr>
