...
<body>
		<table width="920"  border="0" cellspacing="0" cellpadding="0" align="center">
						  ...
						  <tr align="left" valign="top">
							<td><a href="http://www.templatesfreelance.com/"></a><a href="http://www.templatesfreelance.com/"></a>
							  <form id="form1" name="form1" method="post" action="#">
                                <table width="71%" border="0" align="center" cellpadding="0" cellspacing="5">
                                  <tr>
                                    <td colspan="4"><h1>Reset PassWord </h1></td>
                                  </tr>
                                  <tr>
                                    <td colspan="4">&nbsp;</td>
                                  </tr>
                                  <tr>
                                    <td width="21%"><div align="right">Old Password :</div></td>
                                    <td width="2%">&nbsp;</td>
                                    <td width="36%"><input type="text" name="textfield" id="textfield" required="required" /></td>
                                    <td width="41%" rowspan="4"><div align="center"><img src="images/reset-password.jpg" width="244" height="143"></div></td>
                                  </tr>
                                  <tr>
		  ...
		  String email =(String)session.getAttribute("hospital");
		   
			

		rs=stmt.executeQuery("select * from regh where emailid="+"'"+email+"'");
		//String v1="",v2="";
		int found=0;
		while (rs.next())
		{ 
